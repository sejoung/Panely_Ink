...
/**
 * 책 1권. ReaderScreen에 그대로 전달돼 [io.github.sejoung.panelyink.reader.session.CbzBookSession]가 연다.
 *
...
data class BookEntry(
     ...
     * 합쳐서 부모 ZIP과 충돌하지 않게 unique. [io.github.sejoung.panelyink.reader.session.CbzBookSession.open]
     * 과 일치.
     */
